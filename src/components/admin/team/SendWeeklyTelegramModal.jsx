...
export const SendWeeklyTelegramModal = ({ isOpen, onClose, onSend }) => {
  const [selectedWeek, setSelectedWeek] = useState(1);
  const [selectedMonth, setSelectedMonth] = useState(9); // Default to Sept (9)
  ...
  // Helper for ordinal suffix (1st, 2nd, 3rd, 4th, 5th)
